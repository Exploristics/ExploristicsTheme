...
When loading the ExploristicsTheme package, the package changes the default ggplot2 theme to theme_exploristics and changes the default colour palettes to the brand ones.
