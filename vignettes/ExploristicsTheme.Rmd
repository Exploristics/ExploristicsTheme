...
```{r footer_image,results='hide'}
## create a plot and save to a file
png(filename = "example_cars_base_r_plot.png", width = 8, height = 5, units="in", res = 300)
...
## add `theme()` to change additional options or overwrite `exploristics_theme()` default values
ggplot(data = mtcars, aes(x = hp, y = mpg, colour = mpg)) +
  geom_point(size=2) +
  labs(title="Example plot") +
  exploristics_theme() +
